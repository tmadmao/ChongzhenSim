...
export const NATIONAL_POLICIES: NationalPolicy[] = [
  // ── 内政类 ──
  { id: 'light_tax', name: '轻徭薄赋', category: 'internal', description: '降低税压，提振民间经济', status: 'available', cost: 0, researchTurns: 1, effects: [{ type: 'nation', target: 'all', field: 'peopleMorale', delta: 10, description: '民心+10' }, { type: 'treasury', target: 'treasury', field: 'gold', delta: -30, description: '财政-30/季度' }], isHistorical: true },
  { id: 'tax_reform', name: '税制改革', category: 'internal', description: '稳定财政，打击偷税漏税', status: 'locked', cost: 100, researchTurns: 2, effects: [{ type: 'treasury', target: 'treasury', field: 'gold', delta: 80, description: '财政+80' }], requirements: { prerequisitePolicies: ['light_tax'] }, isHistorical: true },
  { id: 'canal_repair', name: '漕运整顿', category: 'internal', description: '修复京杭大运河，保障京师粮运', status: 'available', cost: 150, researchTurns: 2, effects: [{ type: 'treasury', target: 'treasury', field: 'grain', delta: 100, description: '粮食+100/季度' }], isHistorical: true },
  { id: 'salt_tax', name: '盐铁官营优化', category: 'internal', description: '平衡官私盐利，稳定盐税收入', status: 'available', cost: 80, researchTurns: 1, effects: [{ type: 'treasury', target: 'treasury', field: 'gold', delta: 60, description: '盐税+60/季度' }], isHistorical: true },
  { id: 'open_trade', name: '市舶司复开', category: 'internal', description: '重开广州、泉州市舶司，增加海关税收', status: 'available', cost: 50, researchTurns: 1, effects: [{ type: 'treasury', target: 'treasury', field: 'gold', delta: 50, description: '海税+50/季度' }, { type: 'minister', target: 'donglin', field: 'support', delta: -10, description: '东林党反对' }], isHistorical: true },
  { id: 'abolish_mine_tax', name: '矿税监裁撤', category: 'internal', description: '废除矿监税使，缓和官民矛盾', status: 'available', cost: 0, researchTurns: 1, effects: [{ type: 'nation', target: 'all', field: 'peopleMorale', delta: 8, description: '民心+8' }], isHistorical: true },
  { id: 'reduce_royal_stipend', name: '宗室禄米削减', category: 'internal', description: '限制藩王俸禄，缓解财政压力', status: 'available', cost: 0, researchTurns: 1, effects: [{ type: 'treasury', target: 'treasury', field: 'gold', delta: 40, description: '节省宗室开支' }, { type: 'minister', target: 'royal_clan', field: 'support', delta: -20, description: '宗室不满' }], isHistorical: true },
  { id: 'post_reform', name: '驿站裁撤优化', category: 'internal', description: '精简驿站，保障军情传递', status: 'available', cost: 0, researchTurns: 1, effects: [{ type: 'treasury', target: 'treasury', field: 'gold', delta: 20, description: '节省驿站费用' }], isHistorical: true },
  { id: 'tea_horse', name: '茶马互市规范化', category: 'internal', description: '稳定与蒙古、藏地的茶马贸易', status: 'available', cost: 30, researchTurns: 1, effects: [{ type: 'nation', target: 'all', field: 'borderThreat', delta: -5, description: '北方边患-5' }], isHistorical: true },
  { id: 'kaizhong_reform', name: '开中法改良', category: 'internal', description: '优化盐引制度，鼓励商人输粮边疆', status: 'available', cost: 50, researchTurns: 2, effects: [{ type: 'treasury', target: 'treasury', field: 'grain', delta: 80, description: '边粮充足' }], isHistorical: true },
  { id: 'reserve_granary', name: '预备仓扩建', category: 'internal', description: '在各省建立备荒粮仓，应对灾荒', status: 'available', cost: 120, researchTurns: 2, effects: [{ type: 'nation', target: 'all', field: 'peopleMorale', delta: 5, description: '民心稳定' }], isHistorical: true },
  { id: 'paper_money', name: '钞法试行', category: 'internal', description: '尝试发行纸币，缓解通货紧缩', status: 'available', cost: 0, researchTurns: 3, effects: [{ type: 'treasury', target: 'treasury', field: 'gold', delta: 100, description: '短期财政+100' }, { type: 'nation', target: 'all', field: 'peopleMorale', delta: -15, description: '民心不稳' }], isHistorical: false },

  // ── 军事类 ──
  { id: 'border_defense', name: '守边固防', category: 'military', description: '提升边防收益', status: 'available', cost: 100, researchTurns: 1, effects: [{ type: 'nation', target: 'all', field: 'borderThreat', delta: -10, description: '边患-10' }], isHistorical: true },
  { id: 'firearm_innovation', name: '火器革新', category: 'military', description: '强化火器部队战力', status: 'available', cost: 150, researchTurns: 2, effects: [{ type: 'nation', target: 'all', field: 'militaryPower', delta: 15, description: '军力+15' }], isHistorical: true },
  { id: 'capital_garrison', name: '京营整训', category: 'military', description: '整顿京师三大营，恢复禁军战斗力', status: 'available', cost: 200, researchTurns: 2, effects: [{ type: 'nation', target: 'all', field: 'militaryPower', delta: 20, description: '军力+20' }], isHistorical: true },
  { id: 'recruit_system', name: '边军募兵制', category: 'military', description: '逐步替代世兵制，提升兵员素质', status: 'locked', cost: 180, researchTurns: 3, effects: [{ type: 'nation', target: 'all', field: 'militaryPower', delta: 18, description: '军力+18' }], requirements: { prerequisitePolicies: ['border_defense'] }, isHistorical: true },
  { id: 'cart_army', name: '车营重建', category: 'military', description: '复刻戚继光车营战术，对抗骑兵', status: 'locked', cost: 200, researchTurns: 2, effects: [{ type: 'nation', target: 'all', field: 'militaryPower', delta: 20, description: '军力+20' }, { type: 'nation', target: 'all', field: 'borderThreat', delta: -8, description: '边患-8' }], requirements: { prerequisitePolicies: ['firearm_innovation'] }, isHistorical: true },
  { id: 'navy_expand', name: '水师扩建', category: 'military', description: '打造福建水师，抵御倭寇', status: 'available', cost: 160, researchTurns: 2, effects: [{ type: 'province', target: 'fujian', field: 'militaryForce', delta: 20, description: '福建军力+20' }], isHistorical: true },
  { id: 'fortress_line', name: '堡垒防线修筑', category: 'military', description: '在辽东修筑棱堡防线，迟滞后金攻势', status: 'available', cost: 300, researchTurns: 3, effects: [{ type: 'nation', target: 'all', field: 'borderThreat', delta: -20, description: '边患大减' }], isHistorical: true },
  { id: 'military_integration', name: '兵备道整合', category: 'military', description: '统一地方军务指挥，避免权责混乱', status: 'available', cost: 80, researchTurns: 1, effects: [{ type: 'nation', target: 'all', field: 'militaryPower', delta: 8, description: '军力+8' }], isHistorical: true },
